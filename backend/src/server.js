...
// Log de diagnóstico da string de conexão (sem senha)
try {
  ...
  console.log("DATABASE_URL inválida ou não definida.");
}
...
(async () => {
  try {
    ...
    // Não tente continuar se não conectar ao banco
    process.exit(1);
  }
})();

// Cria o servidor HTTP e trata todas as rotas e CORS em um só lugar
